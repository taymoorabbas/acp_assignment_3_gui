...
public class LecturerTablePanel extends JPanel {

    private JTable table;
    private LecturerTableModel tableModel;

    public LecturerTablePanel(){

        this.tableModel = new LecturerTableModel();
    ...
    public int getSelectedRow(){
        ...
        //System.out.println(this.table.getRowSorter().getSortKeys());
